                              ...
                              <td className="px-6 py-4 flex items-center">
                                ...
                                {tab.progress == "in_progress" ? (
                                  <button
                                    ...
                                    className="mr-3 px-3 py-2 border w-24 text-white border-gray-300 rounded-md shadow-sm text-sm bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                                  >
                                    Done
                                  </button>
                                ) : (
                                  <button
                                    ...
                                    className="mr-3 px-3 py-2 border w-24 text-white border-gray-300 rounded-md shadow-sm text-sm bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                                  >
                                    Re open
                                  </button>
                                )}
